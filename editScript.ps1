$javaFilePath = "c:\Users\ikumendibe25\Documents\ERRONKAK\Erronka4_Urko\MAHAIGAINEKO_APLICAZIOA\src\ProduktuakLogika.java"
...
if ($content -contains "esportatuEstatistikak") {
    ...
    # Find and replace the method - find from "public static void esportatuEstatistikak" to the closing brace
    $newMethod = @"
    public static void esportatuEstatistikak() {
            ...
            try {
                ...
                String[] hilabeak = {"", "Urtarrila", "Februari", "Martxoa", "Apirila", "Maiatza", "Ekaina", 
...
"@
    ...
    Set-Content -Path $javaFilePath -Value $content -Encoding UTF8
